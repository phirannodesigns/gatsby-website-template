...
const aClass =
  'hover:bg-gray-100 border hover:border-gray-200 flex group items-center justify-center p-3 rounded-full w-12';
const svgClass =
  'fill-current flex h-full text-gray-600 group-hover:text-gray-700 w-full';
